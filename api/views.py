    ...
    def post(self, request):
        ...
        try:
            ...
            if conversations.exists():
                # conversation = []
                # data = {}
                # for seria in conversations:
                #     seria['company'] = seria.company.name
                #
                #     data['user'] = seria.user.username
                #     data['company'] = seria.company.name
                #     data['message'] = seria.user_message
                #     data['response'] = seria.ai_response
                #     data['timestamp'] = seria.timestamp
